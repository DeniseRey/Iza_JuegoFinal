...
export class Inter3 extends Phaser.Scene {
  ...
  create() {
    this.add.image(this.cameras.main.centerX, this.cameras.main.centerY, 'inter3').setScale(0.83,1);
  ...
  boton1.on('pointerdown', () => {this.scene.start("Play3", {score, vida});
})
  }
